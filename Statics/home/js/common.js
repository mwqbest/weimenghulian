...
function initSearchmenu(searchform, cloudSearchUrl) {
	var defaultUrl = 'http://www.17sucai.com//preview/869565/2017-11-13/js/style/js/search.php?searchsubmit=yes';
...
function patchNotice() {
	if($('patch_notice')) {
		ajaxget('http://www.17sucai.com//preview/869565/2017-11-13/js/style/js/misc.php?mod=patch&action=patchnotice', 'patch_notice', '');
	}
}

function pluginNotice() {
	if($('plugin_notice')) {
		ajaxget('http://www.17sucai.com//preview/869565/2017-11-13/js/style/js/misc.php?mod=patch&action=pluginnotice', 'plugin_notice', '');
	}
}
