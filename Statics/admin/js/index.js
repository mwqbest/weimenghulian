...
layui.config({
	...
	var form = layui.form,
		...
		tab = layui.bodyTab({
			...
			url : "http://"+url_host+'/admin.php/Public/getMenus' //获取菜单json地址
		});
	...
	function lockPage(){
		layer.open({
			...
			content : '	<div class="admin-header-lock" id="lock-box">'+
							'<div class="admin-header-lock-img"><img src="images/face.jpg"/*tpa=http://www.17sucai.com/preview/305986/2017-08-10/layuiCMS-master/js/images/face.jpg*//></div>'+
...
function donation(){
	layer.tab({
		...
		tab : [{
			title : "微信",
			content : "<div style='padding:30px;overflow:hidden;background:#d2d0d0;'><img src='images/wechat.jpg'/*tpa=http://www.17sucai.com/preview/305986/2017-08-10/layuiCMS-master/js/images/wechat.jpg*/></div>"
		},{
			title : "支付宝",
			content : "<div style='padding:30px;overflow:hidden;background:#d2d0d0;'><img src='images/alipay.jpg'/*tpa=http://www.17sucai.com/preview/305986/2017-08-10/layuiCMS-master/js/images/alipay.jpg*/></div>"
		}]
	})
}
