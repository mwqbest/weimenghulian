layui.config({
	...
	$(".search_btn").click(function(){
		...
		if($(".search_input").val() != ''){
            ...
            setTimeout(function(){
            	$.ajax({
					url : "http://www.17sucai.com/preview/305986/2017-08-10/layuiCMS-master/json/newsList.json",
					type : "get",
					dataType : "json",
	...
	$(window).one("resize",function(){
		$(".newsAdd_btn").click(function(){
			var index = layui.layer.open({
				title : "添加文章",
				type : 2,
				content : "newsAdd.html"/*tpa=http://www.17sucai.com/preview/305986/2017-08-10/layuiCMS-master/page/news/newsAdd.html*/,
