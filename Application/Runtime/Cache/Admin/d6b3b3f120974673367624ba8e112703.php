	...
	<form class="layui-form">
		...
		<div class="layui-form-item">
			<div class="layui-inline">
				...
				<div class="layui-input-block">
					<input type="checkbox" name="is_hot" id="is_hot" class="tuijian" title="推荐" <?php if($info['is_hot']==1): ?>checked<?php endif; ?> >
			...
			<div class="layui-inline">		
				...
				<div class="layui-input-inline">
					<input type="text" class="layui-input newsAuthor" name="author" id="author"  placeholder="请输入文章作者" value="<?php echo ($info["author"]); ?>">
				</div>
			</div>
			<div class="layui-inline">		
				<label class="layui-form-label">发布时间</label>
				<div class="layui-input-inline">
					<input type="text" class="layui-input newsTime" name="add_time" id="add_time"  onclick="layui.laydate.render({elem:this})" value="<?php echo (date('Y-m-d',$info["add_time"])); ?>">
				</div>
			</div>
			<div class="layui-inline">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
					<button type="button" class="layui-btn" id="img_upload"style="float: left;"><i class="layui-icon">&#xe67c;</i>上传图片</button>
					<input type="text" name="img" class="layui-input" id="news_img" lay- placeholder="或请输入文章url,格式http://" style="width:80%;float: left;margin-left: 30px;" value=<?php echo ($info["img"]); ?>>
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label">关键字</label>
			<div class="layui-input-block">
				<input type="text" class="layui-input" name="seo_key" id="seo_key" placeholder="请输入文章关键字" value="<?php echo ($info["seo_key"]); ?>">
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label">内容摘要</label>
			<div class="layui-input-block">
				<textarea placeholder="请输入内容摘要" name="abstract" id="abstract" value="<?php echo ($info["abstract"]); ?>" class="layui-textarea"><?php echo ($info["abstract"]); ?></textarea>
			</div>
		</div>
		<div class="layui-form-item">
