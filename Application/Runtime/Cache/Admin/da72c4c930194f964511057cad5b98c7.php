...
<body class="childrenBody">
	<blockquote class="layui-elem-quote news_search">
		...
		<form action="<?php echo u('News/news_category');?>" method="get">
		...
		<div class="layui-inline">
			<a class="layui-btn layui-btn-normal newsCateAdd_btn">添加分类</a>
		</div>
		<!-- <div class="layui-inline">
	...
	<div class="layui-form news_list">
	  	<table class="layui-table">
		    ...
		    <tbody class="news_content">
		    	<?php if(empty($news_cate_list) != true): if(is_array($news_cate_list)): $i = 0; $__LIST__ = $news_cate_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
					            ...
					            <td align="center">
					            	<a class="layui-btn layui-btn-mini news_cate_edit" data-id="<?php echo ($val["id"]); ?>"><i class="iconfont icon-edit"></i> 编辑</a>
					            	<?php if($val['status']==1): ?><a class="layui-btn layui-btn-danger layui-btn-mini news_cate_del" data-id="<?php echo ($val["id"]); ?>"><i class="layui-icon">&#xe640;</i> 删除</a>
					            	<?php else: ?>
	...
	<script type="text/javascript" src="/Statics/admin/js/newsCategoryList.js"></script>
	    <script type="text/javascript" src="/Statics/admin/layui/layui.all.js"></script>
