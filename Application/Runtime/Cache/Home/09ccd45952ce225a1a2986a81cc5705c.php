...
#frameyd1cLA {  border:0px !important;margin:0px !important;}#portal_block_18 {  border:0px !important;margin:0px !important;}#portal_block_18 .dxb_bc {  margin:0px !important;}#framep2n1bg {  border:0px !important;margin:0px !important;}#portal_block_19 {  border:0px !important;margin:0px !important;}#portal_block_19 .dxb_bc {  margin:0px !important;}#frameHCV83Y {  border:0px !important;margin:0px !important;}#portal_block_20 {  border:0px !important;margin:0px !important;}#portal_block_20 .dxb_bc {  margin:0px !important;}#framelo3Fmy {  border:0px !important;margin:0px !important;}#portal_block_21 {  border:0px !important;margin:0px !important;}#portal_block_21 .dxb_bc {  margin:0px !important;}
  ...
  <link href="/Statics/home/css/about.css"rel="stylesheet" type="text/css" />
</div>
          ...
          <div id="portal_block_18" class="block move-span">
            <div id="portal_block_18_content" class="dxb_bc">
              <div class="portal_block_summary">
                ...
                <p>自成立以来，一直专注于互联网品牌建设，我们团队的成员曾务于国内优秀广告公司及互联网公司业务类型涉及WEB视觉、交互设计、移动终端用户体验等质量和信誉是我们存在的基石。我们注重客户提出的每个要求，充分考虑每一个细节，积极的做好服务，努力开拓更好的视野。我们永远不会因为我们曾经的成绩而满足。在所有新老客户面前，我们都很乐意虚心、朴实的跟您接触，更深入的了解您的企业，以便为您提供更优质的服务！
<div>
	&nbsp;</div>
<div>
...
<div>
	&nbsp;</div>
<div>
	感谢您选择，每一次倾心的合作都是一个全新的体会和挑战，让我们从沟通开始这次愉快的合作吧！</div>
</p>
              </div>
            </div>
          </div>
        ...
        <div id="framep2n1bg_left" class="column frame-1-c">
          ...
          <div id="portal_block_19" class="block move-span">
            <div id="portal_block_19_content" class="dxb_bc">
              <div class="portal_block_summary">
                <dl>
                  <dd><img src="/Statics/home/images/guanyu_04.png"></dd>
                  <dt>
                    <h2>我们沉浸于用户体验</h2>
                  </dt>
                  <dt>
                ...
                <dl>
                  <dd><img src="/Statics/home/images/guanyu_06.png"></dd>
                  <dt>
                    <h2>服务思维下的商业设计</h2>
                  </dt>
                  <dt>
                ...
                <dl>
                  <dd><img src="/Statics/home/images/guanyu_08.png"></dd>
                  <dt>
                    <h2>精益合作和分享的态度</h2>
                  </dt>
                  <dt>
            ...
            <div id="portal_block_20_content" class="dxb_bc">
              <div class="portal_block_summary">
                ...
                <div class="project_con">
                  <dl>
                    <dd style="background:url(/Statics/home/images/xiangmu_03.jpg) no-repeat center center;background-size:cover"><a href="#"></a></dd>
                    <dt>从创始至今，我们的业务方向始终不变，专注做好一件事才能更好的追求高品质，这也是我们存在的价值。在未来我们也是基于此信念而继续创造。</dt>
                  </dl>
                  <dl>
                    <dd style="background:url(/Statics/home/images/xiangmu_05.jpg) no-repeat center center;background-size:cover"><a href="#"></a></dd>
                    <dt>在不断的创新和实践中总结出可持续和可信赖的设计流程，坚持与用户一起思考，用设计的方法发现问题、解决问题、输出设计方案，并实现客户产品和企业价值的提升。</dt>
                  </dl>
                  <dl>
                    <dd style="background:url(/Statics/home/images/xiangmu_07.jpg) no-repeat center center;background-size:cover"><a href="#"></a></dd>
                    <dt>多年来积累了大量优秀的项目案例，并验证了设计的价值。在不断的探索中总结经验，以结果为导向，继续为更多客户提供优秀的设计。</dt>
                  </dl>
                </div>
              </div>
            </div>
...
<div class="team_box">
  <div class="team"> 
    ...
    <div id="wk_about_diy4" class="area">
      <div id="framelo3Fmy" class=" frame move-span cl frame-1">
        <div id="framelo3Fmy_left" class="column frame-1-c">
          <div id="framelo3Fmy_left_temp" class="move-span temp"></div>
          <div id="portal_block_21" class="block move-span">
            <div id="portal_block_21_content" class="dxb_bc">
              <div class="portal_block_summary">
                ...
                <div class="team_con">
                  <div class="left_cor">
                    <div class="boxgrid" style="background:url(/Statics/home/images/team_2.jpg) no-repeat;background-size:cover">
                      <div class="cover">
                        <h3>团队建设活动摄影</h3>
                      </div>
                    </div>
                    <div class="boxgrid" style="background:url(/Statics/home/images/team_3.jpg) no-repeat;background-size:cover">
                      <div class="cover">
                        <h3>团队建设活动摄影</h3>
                      </div>
                    </div>
                    <div class="boxgrid" style="background:url(/Statics/home/images/team_4.jpg) no-repeat;background-size:cover">
                      <div class="cover">
                        <h3>团队建设活动摄影</h3>
                      </div>
                    </div>
                    <div class="boxgrid" style="background:url(/Statics/home/images/team_5.jpg) no-repeat;background-size:cover">
                      <div class="cover">
                        <h3>团队建设活动摄影</h3>
                      </div>
                    </div>
                  ...
                  <div class="right_cor">
                    <div class="boxgrid" style="background:url(/Statics/home/images/team_6.jpg) no-repeat;background-size:cover">
                      <div class="cover1">
                        <h3>团队建设活动摄影</h3>
                      </div>
                    </div>
